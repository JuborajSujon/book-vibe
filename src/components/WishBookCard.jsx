...
const WishBookCard = ({ wishBooks, handleDeleteWishBook }) => {
  const {
    image,
    bookName,
    author,
  ...
  return (
    <section className="relative text-clr-primary border rounded-lg border-gray-200 p-6">
      ...
      <div
        ...
        data-tip="Delete">
        <button
          onClick={() => handleDeleteWishBook(bookId)}
...
WishBookCard.propTypes = {
  wishBooks: PropTypes.object.isRequired,
  handleDeleteWishBook: PropTypes.func.isRequired,
};
